...
<div class="content-page">
    <div class="content">
        ...
        <div class="container-fluid">
            <h2 class="mt-3 mb-3 ">Create shipment</h2>
            <div class="row">
                <form action="../php_functionality/create_shipment_functionality.php" method="post">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select select3" multiple name="region[]" id="region" required>
                            <option value="" disabled>--Select The City--</option>
                            <option value="Islamabad">Islamabad</option>
                            <option value="Punjab">Punjab Cities</option>
                            ...
                            <option value="Sindh">Sindh Cities</option>
                            ...
                            <option value="Khyber">Khyber Cities</option>
                            ...
                            <option value="Balochistan">Balochistan Cities</option>

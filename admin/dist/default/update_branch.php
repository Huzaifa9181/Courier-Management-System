...
<div class="content-page">
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <form action="../php_functionality/update_branch_functionality.php" method="post">
                <div class="mb-3">
                        <label for="Username" class="form-label">Branch Name <span style="color: red;">*</span></label>
                        <input type="text" placeholder="Enter Your Branch Name" name="name" value="<?php echo $row['name']; ?>" class="form-control"
                            id="Username" required>
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Branch Email address <span style="color: red;">*</span></label>
                        <input type="email" class="form-control" value="<?php echo $row['email']; ?>" id="exampleInputEmail1" name="email"
                    ...
                    <div class="mb-3">
                        <label for="password" class="form-label">Country <span style="color: red;">*</span></label>
